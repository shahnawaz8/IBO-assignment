...
// Problem 2. you need to write a function say, getUniquePrducts which should
//  return an array of objects by grouping the products based on the productName
//   and summing up the quantity for the same products present in the given list 
